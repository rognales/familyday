      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12 text-center"><img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(186)->generate($participant->qr())) !!} ">
                </td>
              </div>
            </div>
            <br />
...
<fieldset>
                ...
                <mark><strong>{{$participant->email}}</strong></mark></li>
                    <li>You may now proceed with online payment.</li>
                    <li>Payment must be done before
                <mark><strong>{{ \Carbon\Carbon::parse(config('familyday.paymentday'))->format('jS F Y') }}</strong></mark>.</li>
              ...
              @csrf
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="number" class="form-control" id="payment-amount" name="amount" placeholder="{{$participant->total_price}}" required value="{{old('amount')}}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="payment-reference" class="col-lg-3 control-label">Reference #</label>
                    <div class="col-lg-9">
                      <input type="text" class="form-control" id="payment-reference" name="reference" required value="{{old('reference')}}">
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <table class="table table-condensed table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-right" title="{{$upload->paid_at}}">{{$upload->paid_at->toDateString()}}</td>
