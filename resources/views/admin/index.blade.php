        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Admin
                        Dashboard</h3>
                </div>
                <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <div class="caption text-center">
                                    ...
                                    <h3>Registration</h3>
                                    <p>View registration details including summary. You can also resend the email
                                        confirmation.</p>
                                    <a href="{{route('admin_user')}}" class="btn btn-primary btn-md"
                                        role="button">Manage Registration</a>
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <div class="caption text-center">
                                    ...
                                    <a href="{{route('admin_payment')}}" class="btn btn-primary btn-md"
                                        role="button">Manage Payment</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <div class="caption text-center">
                                    ...
                                    <a href="{{route('admin_attend')}}" class="btn btn-primary btn-md"
                                        role="button">View Attendance</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <div class="caption text-center">
                                    ...
                                    <a href="{{route('admin_staff')}}" class="btn btn-primary btn-md" role="button">View
                                        Staff</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <div class="caption text-center">
                                    ...
                                    <a href="{{route('admin_member')}}" class="btn btn-primary btn-md"
                                        role="button">View Member</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <p class="text-center">&copy; {{now()->year}} Alasapan Inc.
                        <span class="pull-right label label-success">v {{app()->version()}}</span>
                    </p>
                </div>
            </div>
        </div>
