...
class AdminController extends Controller
{
     ...
     $p = Participant::with(['payment'])->latest();
      ...
      return Datatables::of($p)
          ...
          ->addColumn('action', function ($p) {
              ...
              $href ='<div class="btn-group" role="group" aria-label="...">';

              $href .= '<a href="'. route('registration_show', ['slug' => $p->slug()]). '" data-pid="'.$p->id.'" id="view-'.$p->id.'" class="btn btn-primary btn-view" role="button" target="_blank" title="View registration summary &amp; details"><i class="glyphicon glyphicon-search"></i></a>';
   ...
   public function attend(){
      ...
      return view('admin.attend',compact('count','payment','attendance','member'));
   }
    ...
    $p = Participant::select(['id','name','email','staff_id','member','attend'])
        ...
        return Datatables::of($p)
            ...
            ->addColumn('action', function ($p) {
                  ...
                  $href .= '<a href="'. route('registration_show', ['slug' => $p->slug()]). '" data-pid="'.$p->id.'" id="view-'.$p->id.'" class="btn btn-primary btn-view" target="_blank"><i class="glyphicon glyphicon-search"></i></a>';
   ...
   public function attend_full(){
      ...
      return view('admin.attendFull',compact('count','payment','attendance','member'));
   }
   ...
   public function user_ajax() {
    ...
    $p = Participant::select(['id','name','email','staff_id','member']);
      ...
      ->addColumn('action', function ($p) {
            ...
            $href .= '<a href="'. route('registration_show', ['slug' => $p->slug()]). '" data-pid="'.$p->id.'" id="view-'.$p->id.'" class="btn btn-primary btn-view" target="_blank" title="View registration summary &amp; details"><i class="glyphicon glyphicon-search"></i></a>';
  ...
  public function user_ajax_old()
  {
   ...
   $p = Participant::select(['id','name','email','staff_id','member'])->latest()
     ...
     return Datatables::of($p)
     ->addColumn('action', function ($p) {
           $href ='<a href="'. route('registration_show', ['slug' => $p->slug()]). '" data-pid="'.$p->id.'" id="view-'.$p->id.'" class="btn btn-xs btn-primary btn-view" target="_blank" title="View"><i class="glyphicon glyphicon-search"></i> View</a>';
  ...
  public function attend_ajax_old()
  {
    ...
    //$p = Participant::with('dependants')->select('participants.*');
     return Datatables::of($p)
         ->removeColumn('member')
         ->addColumn('action', function ($p) {
               return '<a href="'. route('registration_show', ['slug' => $p->slug()]). '" data-pid="'.$p->id.'" id="view-'.$p->id.'" class="btn btn-xs btn-primary btn-view" target="_blank"><i class="glyphicon glyphicon-search"></i> View</a>';
           })
         ->addColumn('details_url', function($p) {
             return route('admin_dependants_ajax', ['pid' => $p->id]);
               })
